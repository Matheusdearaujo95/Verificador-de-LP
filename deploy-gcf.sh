...
gcloud functions deploy "$FUNCTION_NAME" \
  ...
  --memory=256Mi \
  --timeout=120s \
  --set-env-vars="VIGIA_PROVIDER_NAME=Google Cloud Functions,VIGIA_STATE_BACKEND=gcs,VIGIA_GCS_BUCKET=${BUCKET_NAME},VIGIA_CONFIG_URL=https://cdn.jsdelivr.net/gh/SEU_USUARIO/SEU_REPO@main/config.json"
